...
export default function HotelsListingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50  dark:bg-zinc-900/90">
      {/* Search Bar */}
      <div
        className={`transition-all duration-300 ease-in-out bg-indigo-700 dark:bg-blue-950 py-6 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-zinc-800 rounded-lg shadow p-4">
            <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
              ...
              <button className="bg-indigo-600 dark:bg-blue-900 text-white py-2 px-4 rounded-md hover:bg-indigo-700 dark:hover:bg-blue-800 flex items-center justify-center gap-2">
                <Search size={18} />
                Search
              </button>
            </div>
