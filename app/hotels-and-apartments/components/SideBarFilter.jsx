...
const SideBarFilter = () => {
  ...
  return (
    <div>
      <div className="w-full md:w-80 bg-white dark:bg-zinc-800 p-6 rounded-lg shadow h-fit">
        ...
        <button className="w-full bg-indigo-600 dark:bg-blue-950 text-white py-2 rounded-md hover:bg-indigo-700 dark:hover:bg-blue-800">
          Apply Filters
        </button>
      </div>
    </div>
