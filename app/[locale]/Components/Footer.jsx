      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/destinations/colombo" className="hover:text-white">
                  Colombo
                </Link>
              </li>
              <li>
                <Link href="/destinations/kandy" className="hover:text-white">
                  Kandy
                </Link>
              </li>
              <li>
                <Link href="/destinations/galle" className="hover:text-white">
                  Galle
                </Link>
              </li>
              <li>
                <Link href="/destinations/ella" className="hover:text-white">
                  Ella
                </Link>
              </li>
              <li>
                <Link href="/destinations/mirissa" className="hover:text-white">
                  Mirissa
                </Link>
              </li>
              <li>
