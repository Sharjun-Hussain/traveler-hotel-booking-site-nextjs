...
export function SignupForm({ className, ...props }) {
    ...
    async function onSubmit(values) {
        ...
        try {
            ...
            toast.success("Account created successfully!", {
                description: "You can now book your next adventure",
            });
    ...
    return (
        <div className={cn("flex justify-between min-h-screen ", className)} {...props}>
            {/* Left side - Visuals */}
            <div className="hidden md:flex bg-gradient-to-br from-blue-600 to-indigo-900 p-12 flex-col justify-between w-1/2 text-white">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-blue-100 text-lg">
                        Join millions of travelers finding their perfect stays and experiences
                        worldwide.
                    </p>
                </div>
                ...
                <div className="w-full max-w-full">
                    <div className="mb-8 space-y-2">
                        ...
                        <p className="text-muted-foreground">
                            Join to unlock exclusive deals and personalized recommendations
                        </p>
                    </div>
                            ...
                            <Form {...form}>
                                ...
                                >
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <div className={`grid ${isApple ? "grid-cols-2" : ""}  gap-3`}>
                                            {isApple && (
                                                <Button
